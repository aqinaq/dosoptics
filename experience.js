(() => {
  ...
  if (!stage) return;
  const copy = {
    kk:{concept:'КОНЦЕПТ / 01',drag:'Сүйреп бұрыңыз',rotate:'Айналдыру',pause:'Тоқтату',kind:'Дизайн прототипі',colors:['Түнгі көк','Піл сүйегі','Кәріптас'],names:['DOS / LINE 01','DOS / LINE 02','DOS / SUN 03'],types:['Ацетат пішіні','Жұқа металл пішіні','Күннен қорғайтын пішін'],fallback:'3D бұл құрылғыда қолжетімсіз. Графикалық нұсқа көрсетілді.',canvas:'Көзілдіріктің 3D көрінісі. Бұру үшін сүйреңіз немесе бағыт пернелерін басыңыз. Бастапқы көрініс үшін Home.'},
    ru:{concept:'КОНЦЕПТ / 01',drag:'Перетаскивайте для вращения',rotate:'Вращать',pause:'Остановить',kind:'Дизайн-прототип',colors:['Ночной синий','Слоновая кость','Янтарь'],names:['DOS / LINE 01','DOS / LINE 02','DOS / SUN 03'],types:['Ацетатная форма','Тонкая металлическая форма','Солнцезащитная форма'],fallback:'3D недоступно на этом устройстве. Показана иллюстрация.',canvas:'3D-модель очков. Перетаскивайте или используйте стрелки для вращения. Home возвращает исходный ракурс.'},
    en:{concept:'CONCEPT / 01',drag:'Drag to rotate',rotate:'Rotate',pause:'Pause',kind:'Design prototype',colors:['Midnight blue','Ivory','Amber'],names:['DOS / LINE 01','DOS / LINE 02','DOS / SUN 03'],types:['Acetate frame','Slim metal frame','Sunglasses frame'],fallback:'3D is unavailable on this device. Showing an illustration.',canvas:'3D view of glasses. Drag or use arrow keys to rotate. Press Home to reset the view.'}
  };

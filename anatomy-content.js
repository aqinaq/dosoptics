  ...
  const copy = {
    kk: {
      ...
      groups:[
        ...
        {title:'Көру және көзілдірік',items:[['Көруді тексеру қанша тұрады?','Алдын ала жазылсаңыз, тексеру тегін.'],['Тексеру қанша уақыт алады?','Шамамен 15 минут.'],['Көзілдірік қашан дайын болады?','Әдеттегі мерзім — 1 күн. Нақты уақыт рецепт пен таңдалған линзаға байланысты.'],['Көзілдірікті қайтаруға бола ма?','Тауарлық күйі сақталса, жақтауды қайтаруға болады. Линзалар қайтарылмайды.']]},
        {title:'Линзалар мен жөндеу',items:[['Қандай жанаспалы линзалар бар?','Стандартты қисықтықтағы бір күндік, екі апталық және айлық линзалар ұсынылады.'],['Қандай линзалар тапсырыспен келеді?','Астигматикалық, үш айлық және ұзақ тағылатын арнайы линзалар.'],['Көзілдірікті жөндейсіздер ме?','Иә. Түзету, дәнекерлеу, саптарын ауыстыру және басқа жұмыстар жасалады. Бағасы жұмыстың күрделілігіне байланысты.']]},
        {title:'Кепілдік пен ұсыныстар',items:[['Рецептке кепілдік бар ма?','DOS-та тексеруден өткен болсаңыз, рецептке 1 ай кепілдік беріледі.'],['Қандай пакеттер бар?','Жарияланған пакет бағалары: 7 995, 9 995, 14 900, 16 900, 24 950 және 26 950 ₸. Құрамы мен шарттарын салоннан біліңіз.'],['Бонус қалай есептеледі?','Алғашқы сатып алудың 20%-ы бонус түрінде қайтарылады. Бонус 6 ай жарамды.'],['Көзілдірікке қандай кепілдік бар?','Сатып алғаннан кейін 1 жыл сервистік қызмет көрсетіледі.']]}
      ], book:'Тексеруге жазылу ↗', salons:'Салондарды көру ↗'
    },
    ru: {
      ...
      groups:[
        ...
        {title:'Зрение и очки',items:[['Сколько стоит проверка зрения?','По записи проверка бесплатна.'],['Сколько длится проверка?','Около 15 минут.'],['Когда будут готовы очки?','Обычно за 1 день. Точный срок зависит от рецепта и линз.'],['Можно ли вернуть очки?','Оправу можно вернуть при сохранении товарного вида. Линзы возврату не подлежат.']]},
        {title:'Линзы и ремонт',items:[['Какие контактные линзы есть?','Однодневные, двухнедельные и месячные со стандартной кривизной.'],['Какие линзы заказывают отдельно?','Астигматические, трёхмесячные и специальные линзы длительного ношения.'],['Ремонтируете ли вы очки?','Да: выправка, пайка, замена дужек и другие работы. Стоимость зависит от сложности.']]},
        {title:'Гарантия и предложения',items:[['Есть ли гарантия на рецепт?','После проверки зрения в DOS рецепт действует с гарантией 1 месяц.'],['Какие есть пакеты?','Опубликованные цены пакетов: 7 995, 9 995, 14 900, 16 900, 24 950 и 26 950 ₸. Состав и условия уточняйте в салоне.'],['Как работают бонусы?','20% от первой покупки возвращаются бонусами. Срок действия — 6 месяцев.'],['Есть ли гарантия на очки?','Сервисное обслуживание действует 1 год после покупки.']]}
      ],book:'Записаться на проверку ↗',salons:'Посмотреть салоны ↗'
    },
    en: {
      ...
      groups:[
        ...
        {title:'Eye exams and glasses',items:[['How much is an eye exam?','It is free with an appointment.'],['How long does the exam take?','About 15 minutes.'],['When will glasses be ready?','Typically in one day; timing depends on the prescription and chosen lenses.'],['Can glasses be returned?','Frames may be returned if kept in saleable condition. Lenses cannot be returned.']]},
        {title:'Lenses and repairs',items:[['Which contact lenses are available?','Daily, two-week and monthly lenses with standard base curves.'],['Which lenses require an order?','Toric, three-month and specialty extended-wear lenses.'],['Do you repair glasses?','Yes. Services include adjustments, soldering, temple replacement and more. Cost depends on the work.']]},
        {title:'Guarantees and offers',items:[['Is there a prescription guarantee?','A prescription from an exam at DOS is covered for one month.'],['Which packages are offered?','Published package prices are 7,995, 9,995, 14,900, 16,900, 24,950 and 26,950 ₸. Ask a store about contents and terms.'],['How do bonuses work?','20% of the first purchase is returned as bonuses, valid for six months.'],['Is there a glasses guarantee?','Service support lasts one year after purchase.']]}
      ],book:'Book an eye exam ↗',salons:'Find a store ↗'
    }
  };
  const host=document.querySelector('#salons');
  if(!host)return;

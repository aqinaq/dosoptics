(() => {
  ...
  const copy={
    ...
    en:{serviceTitle:'What does DOS offer?',facts:[['20 / 7','20 stores · 7 cities'],['7,995 ₸','Starting price for promotional packages'],['≈15 min','Free eye exam by appointment'],['20%','Bonus on your first purchase; valid for 6 months']],terms:'Confirm prices and offer terms with DOS.',contactTitle:'Contact lenses, too.',contactText:'Daily, biweekly and monthly lenses; toric and specialty options available to order.',social:'DOS on Instagram ↗',official:'Prices and services ↗'}
  };
  ...
  function render(){const l=document.documentElement.lang,c=copy[l];
